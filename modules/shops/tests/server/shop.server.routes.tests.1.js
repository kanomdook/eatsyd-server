                  ...
                  .end(function (shopGetErr, shopsGetRes) {
                    ...
                    agent.put('/api/changecover/' + shops._id)
                      ...
                      .end(function (changecoverErr, changecoverRes) {
                        ...
                        (shopchange.items[0].cate.name).should.match(categoryproduct.name);
                        (shopchange.items[0].products[0].image).should.match(products.images[0]);
                        done();
                      });
                  });
              });
                  ...
                  .end(function (shopGetErr, shopsGetRes) {
                    ...
                    agent.put('/api/createcate/' + shops._id)
                      ...
                      .end(function (changecoverErr, changecoverRes) {
                        ...
                        (shopchange.coverimage).should.match(shop.coverimage);
                        (shopchange.promoteimage).should.match(shop.promoteimage);
                        (shopchange.items.length).should.match(2);
                        (shopchange.items[0].cate.name).should.match(categoryproduct.name);
                        (shopchange.items[0].products[0].image).should.match(products.images[0]);
                        (shopchange.items[1].cate.name).should.match(cate.name);
                        (shopchange.items[1].products.length).should.match(0);
                        done();
                      });
                  });
              });
                    ...
                    agent.put('/api/createcate/' + shops._id)
                      ...
                      .end(function (changecoverErr, changecoverRes) {
                        ...
                        var productCreate = {
                          ...
                          images: ['asdf', 'asdf'],
                          price: 1234,
                          categories: shopchange.items[1].cate
                        };
                        agent.put('/api/createproduct/' + shops._id)
                          ...
                          .end(function (createproductErr, createproductRes) {
                            ...
                            (shopProduct.items.length).should.match(2);
                            (shopProduct.items[0].cate.name).should.match(categoryproduct.name);
                            (shopProduct.items[0].products[0].image).should.match(products.images[0]);
                            (shopProduct.items[1].cate.name).should.match(cate.name);
                            (shopProduct.items[1].products.length).should.match(1);
                            var productCreate = {
                              name: 'sadf',
                              images: ['asdf', 'asdf'],
                              price: 1234,
                            ...
                            agent.put('/api/createproduct/' + shops._id)
                              ...
                              .end(function (createproductErr, createproductRes) {
                                ...
                                (shopProduct.items.length).should.match(2);
                                (shopProduct.items[0].cate.name).should.match(categoryproduct.name);
                                (shopProduct.items[0].products.length).should.match(2);
                                (shopProduct.items[0].products[0].image).should.match(products.images[0]);
                                (shopProduct.items[0].products[1].image).should.match('asdf');
                                (shopProduct.items[1].cate.name).should.match(cate.name);
                                (shopProduct.items[1].products.length).should.match(1);
                                done();
                              });
